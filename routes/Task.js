...
router.get("/task/:id", taskController.getTaskById) // GET /tasks/:id
router.put("/task/:id", taskController.updateTask) // PUT /tasks/:id
router.delete("/task/:id", taskController.deleteTask) // DELETE /tasks/:id
